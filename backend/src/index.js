...
const options = {
  definition: {
    openapi: "3.0.0",
      info: {
        version: "1.0.0",
        title: "ADVOCACY INITIATIVE NETWORK",
        description: "ADVOCACY INITIATIVE NETWORK Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
...
app.use('/api/newsletters', passport.authenticate('jwt', {session: false}), newslettersRoutes);
