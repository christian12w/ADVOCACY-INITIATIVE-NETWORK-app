...
const Dashboard = () => {
    ...
    const [newsletters, setNewsletters] = React.useState(loadingMessage);
    const [subscriptions, setSubscriptions] = React.useState(loadingMessage);
    const [roles, setRoles] = React.useState(loadingMessage);
    const [permissions, setPermissions] = React.useState(loadingMessage);

    async function loadData() {
        const entities = ['users','events','newsletters','subscriptions','roles','permissions',];
        const fns = [setUsers,setEvents,setNewsletters,setSubscriptions,setRoles,setPermissions,];
    ...
    <>
      ...
      <SectionMain>
        ...
        <div id="dashboard" className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
            ...
            <Link href={'/newsletters/newsletters-list'}>
                <div
                    className={`${corners !== 'rounded-full'? corners : 'rounded-3xl'} dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                >
                    <div className="flex justify-between align-center">
